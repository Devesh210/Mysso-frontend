...
const EducationalExpertStudentProfileview = () => {
        ...
        <div>
            <Container fluid className='matrimonialform mt-3 mb-5'>
                <Row style={{ justifyContent: 'end' }}>
                    ...
                    <Button className='addbtn' style={{ width: 'auto', marginBottom: '20px' }} onClick={() => Navigate(-1)}>Back</Button>
                </Row>
...
export default EducationalExpertStudentProfileview