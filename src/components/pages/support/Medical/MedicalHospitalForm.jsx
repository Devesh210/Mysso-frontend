...
const MedicalHospitalForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/createHospital`, requestoptions)
                        ...
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formFullName">
                                    <Form.Control type="text" placeholder='Enter Hospital Name' onChange={(e) => setHospitalName(e.target.value)} ref={HospitalNameRef}/>
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Hospital Type <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formGender">
                                    <Form.Select className='mb-3' onChange={(e) => setHospitalType(e.target.value)} ref={HospitalTypeRef}>
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formFullName">
                                    <Form.Control type="text" placeholder='Please Enter Your Email Address' onChange={(e) => setEmail(e.target.value)} ref={EmailRef}/>
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Website URL </label>
                                <Form.Group className="mb-3" controlId="formFullName">
                                    <Form.Control type="text" placeholder='Please Enter Your Website URL' onChange={(e) => setWebsite(e.target.value)} />
                                </Form.Group>
                            </Col>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formFullName">
                                    <Form.Control type="text" placeholder='Enter Number of Branches' onInput={allowOnlyNumbers} maxLength={3} onChange={(e) => setNumberOfBranches(e.target.value)} ref={NumberOfBranchesRef}/>
                                </Form.Group>
                            </Col>
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formGender">
                                    <Form.Select className='mb-3' onChange={(e) => setParkingFacilities(e.target.value)} >
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formGender">
                                    <Form.Select className='mb-3' onChange={(e) => setTwentyFourSeven(e.target.value)} ref={TwentyFourSevenRef}>
                                        <option hidden>Select</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </Form.Select>
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formGender">
                                    <Form.Select className='mb-3' onChange={(e) => setCashlessFacilities(e.target.value)}>
                                        <option hidden>Select</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </Form.Select>
...
export default MedicalHospitalForm;