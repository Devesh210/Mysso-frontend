...
const SeniorNGOForm = () => {
    ...
    const [chargeable, setChargeable] = useState('No');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!ngoName) {
                ...
                formData.append('chargeable', chargeable);
                ...
                await fetch(`${API_URL}/api/createSeniorCitizenNgo`, requestoptions)
                    .then(response => response.json())
                    .then(data => {
                        console.log(data);
                        if (data.status == 200) {
                    ...
                    <div className='profilegallery mb-5'>
                        ...
                        <div className='descr-content'>
                            <Row>
                                ...
                                <Col lg={4} className='mb-2'>
                                    <label>Is your NGO services chargeable? </label>
                                    <Form.Group className="mb-3">
                                ...
                                <Col lg={4} className='mb-2'>
                                    ...
                                    <div className='profileimgc12' tabindex="0" id="focusableDiv">
                                ...
                                <Col lg={4} className='mb-2'>
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Control
                                            ...
                                            value={officeAddress}
                                            onChange={(e) => setOfficeAddress(e.target.value.slice(0, maxCharacters))}
                                            ref={officeaddressRef}
                                            style={{ height: '180px' }}
                                        />
                                        <small className='text-muted'>{officeAddress.length}/{maxCharacters} characters</small>
                                            ...
                                            <Row>
                                                ...
                                                <Col lg={4} className='mb-2'>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        onChange={(e) => handleSubBranchChange(index, 'address', e.target.value.slice(0, maxCharacters))}
                                                    />
                                                    <small className='text-muted'>{branch.address.length}/{maxCharacters} characters</small>
                                                </Col>
                                ...
                                <Col lg={4} className='mb-2'>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control
                                            ...
                                            placeholder="Enter availability details"
                                            value={availability}
                                            onChange={(e) => setAvailability(e.target.value.slice(0, maxCharacters))}
                                            ref={availabilityRef}
                                            style={{ height: '180px' }}
                                        />
                                        <small className='text-muted'>{availability.length}/{maxCharacters} characters</small>
                                ...
                                <Col lg={4} className='mb-2'>
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Control
                                            ...
                                            onChange={(e) => setServicesDescription(e.target.value.slice(0, maxCharacters))}
                                            style={{ height: '180px' }}
                                            ref={servicesdescriptionRef}
                                        />
                                        <small className='text-muted'>{servicesDescription.length}/{maxCharacters} characters</small>
                                ...
                                <Col lg={4} className='mb-2'>
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Control
                                            ...
                                            onChange={(e) => setSuccessStories(e.target.value.slice(0, maxCharacters))}
                                            style={{ height: '180px' }}
                                        />
                                        <small className='text-muted'>{successStories.length}/{maxCharacters} characters</small>
