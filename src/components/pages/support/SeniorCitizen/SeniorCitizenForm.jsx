    ...
    const handleSubmit = async () => {
        try{
            ...
            const requestoptions = {
                ...
                await fetch(`${API_URL}/api/createSeniorCitizen`, requestoptions)
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    if (data.status == 200) {
            ...
            <Container fluid className='matrimonialform mt-5 mb-5'>
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formLanguage">
                                    {/* <Form.Control type="text" placeholder="Enter Address" value={address} onChange={(e) => setAddress(e.target.value)} ref={addressRef}/> */}
                                    <Form.Control
                                        as="textarea"
                                        rows={3}
                                        style={{ height: '180px' }}
                                        placeholder="Enter Address"
                                        value={address} onChange={(e) => setAddress(e.target.value.slice(0, maxCharacters))}
                                        ref={addressRef}
                                    />
                                    <small className='text-muted'>{address.length}/{maxCharacters} characters</small>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formSkills">
                                    <Form.Control
                                        ...
                                        onChange={(e) => setPastTreatments(e.target.value.slice(0, maxCharacters))}
                                    />
                                    <small className='text-muted'>{pastTreatments.length}/{maxCharacters} characters</small>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formSkills">
                                    <Form.Control
                                        ...
                                        onChange={(e) => setRegularMedication(e.target.value.slice(0, maxCharacters))}
                                    />
                                    <small className='text-muted'>{regularMedication.length}/{maxCharacters} characters</small>
                ...
                <div className='profilegallery mb-5'>
                    ...
                    <div className='descr-content'>
                        <Row>
                            <Col lg={4} className='mb-2'>
                                <label>Meal Preferences <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formMealPreferences">
                                    {/* <Form.Select className='mb-3' value={mealPreferences} onChange={(e) => setMealPreferences(e.target.value)} ref={mealPreferencesRef}>
                            ...
                            <Col lg={4} className='mb-2'>
                                <label>Meal Timing <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formSkills">
                                    {/* <Form.Select className='mb-3' value={mealTiming} onChange={(e) => setMealTiming(e.target.value)} ref={mealTimingRef}>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formSkills">
                                    <Form.Control
                                        ...
                                        onChange={(e) => setDietaryRestrictions(e.target.value.slice(0, maxCharacters))}
                                    />
                                    <small className='text-muted'>{dietaryRestrictions.length}/{maxCharacters} characters</small>
