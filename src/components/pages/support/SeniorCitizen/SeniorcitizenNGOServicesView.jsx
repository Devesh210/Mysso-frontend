...
const SeniorcitizenNGOServicesView = () => {
    ...
    <div>
      <Container fluid className='matrimonialform mt-5 mb-5'>
        <Row style={{ justifyContent: 'end' }}>
          <Button className='addbtn' style={{ width: 'auto', marginBottom: '20px' }} onClick={() => Navigate(`/SeniorcitizenNGOServicesEdit?id=${services?._id}`)}>Edit </Button>
          <Button className='addbtn' style={{ width: 'auto', marginBottom: '20px' }} onClick={() => Navigate(`/SeniorcitizenNGOServicesList?id=${ngo_id}`)}>Back To Services List </Button>
        </Row>
...
export default SeniorcitizenNGOServicesView