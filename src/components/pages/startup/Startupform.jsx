...
const Startupform = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            //     return;
            // }
            else if (founderContact && (!isfounderPhoneValid)) {
                swal({
                ...
                swal({
                    text: "Please enter PitchDeck",
                    icon: "warning",
                })
                pitchDeckRef.current.focus();
                return;
            }
            ...
            await fetch(`${API_URL}/api/addStartup`, requestoptions)
    ...
    return (
        <div>
            <Container fluid className='matrimonialform mt-5 mb-5'>
                    ...
                    <div className='descr-content'>
                        <Row>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Select className='mb-3' onChange={(e) => setBusinessType(e.target.value)} ref={businessTypeRef}>
                                        ...
                                        {businessTypeList?.map((val, index) => (
                                            <option key={index} value={val?._id}>{val?.startupbusiness_type}</option>
                                        ))}
                                    </Form.Select>
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Registration Number/CIN No." onChange={(e) => setRegistrationNumber(e.target.value)} ref={registrationNumberRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Date of Incorporation <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="date" placeholder="Enter Company Name" onChange={(e) => setDateOfIncorporation(e.target.value)} ref={dateOfIncorporationRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Business Email ID" onChange={(e) => setBusinessEmail(e.target.value)} ref={businessemailRef} />
                                </Form.Group>
                            </Col>
                ...
                <div className='profilegallery mb-5'>
                    <h3 className='text-center'>Founder’s / Owner’s Information</h3>
                    <div className='descr-content'>
                        <Row>
                            <Col lg={4} className='mb-2'>
                                <label>Full Name <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Full Name" onChange={(e) => setFounderName(e.target.value)} ref={founderNameRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Date of Birth <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="date" placeholder="Enter Company Name" onChange={(e) => setFounderDOB(e.target.value)} ref={founderDOBRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Founders/Owners Valid Government issued ID Number" onChange={(e) => setFounderID(e.target.value)} ref={founderIDRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="email" placeholder="Enter Company Name" onChange={(e) => setFounderEmail(e.target.value)} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Contact Number </label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    {/* <Form.Control type="text" placeholder="Enter Company Name" onChange={(e) => setFounderContact(e.target.value)} /> */}
                                    <PhoneInput
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Business Activity Description" onChange={(e) => setBusinessActivity(e.target.value)} ref={businessActivityRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Number of Employees </label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Number of Employees" onInput={allowOnlyNumbers} onChange={(e) => setNumOfEmployees(e.target.value)} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Annual Revenue (Projected) </label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="currency" placeholder="Enter Annual Revenue (Projected)" onInput={allowOnlyNumbers} onChange={(e) => setAnnualRevenue(e.target.value)} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Select className='mb-3' onChange={(e) => setStartupStage(e.target.value)} ref={startupStageRef}>
                                        ...
                                        {startupStageList?.map((val, index) => (
                                            <option key={index} value={val._id}>{val.startup_stage}</option>
                                        ))}
                                    </Form.Select>
                                </Form.Group>
                            </Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Select className='mb-3' onChange={(e) => setRevenueModel(e.target.value)} ref={revenueModelRef}>
                                        ...
                                        {revenueModelList?.map((val, index) => (
                                            <option key={index} value={val._id}>{val.startup_revenue}</option>
                                        ))}
                                    </Form.Select>
                                </Form.Group>
                            </Col>
                    ...
                    <div className='descr-content'>
                        <Row>
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Tax Identification Number (TIN)" onChange={(e) => setTaxNumber(e.target.value)} ref={taxNumberRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Preferred Experience of Investor in Years" onInput={allowOnlyNumbers} onChange={(e) => setInvestorExperience(e.target.value)} ref={investorExperienceRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Minimum Investment Required <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Minimum Investment Required" onInput={allowOnlyNumbers} onChange={(e) => setMinInvestment(e.target.value)} ref={minInvestmentRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Maximum Investment Required <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Maximum Investment Required" onInput={allowOnlyNumbers} onChange={(e) => setMaxInvestment(e.target.value)} ref={maxInvestmentRef} />
                                </Form.Group>
                            </Col>
                    ...
                    <div className='descr-content'>
                        <Row>
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Previous Funding" onInput={allowOnlyNumbers} onChange={(e) => setPreviousFunding(e.target.value)} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control
                                        as="textarea"
                                        rows={3}
                                        placeholder="Enter Reference Contacts"
