...
const MatrimonyInterested = () => {
    ...
    const getdetails = () => {
        ...
        try {
            ...
            fetch(`${API_URL}/api/getLikedProfiles`, requestOptions)
                            ...
                            <Col lg={9}>
                                <div className='dataright'>
                                    <Row className='profilelocation'>
                                        ...
                                        <Col lg={6}>
                                                <button className="view-user-profile" onClick={() => removelikedprofile(data._id)}>Remove</button>
...
export default MatrimonyInterested