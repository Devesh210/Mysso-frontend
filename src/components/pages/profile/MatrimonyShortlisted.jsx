...
const MatrimonyShortlisted = () => {
    ...
    const getdetails = () => {
        ...
        try {
            ...
            fetch(`${API_URL}/api/getShortlistedProfiles`, requestOptions)
    ...
    const removeshortlisted = async(id) => {
        try{
            ...
            console.log(id)
            // return false
            await fetch(`${API_URL}/api/removeShortlistedProfile`, requestOption)
                .then((res) => res.json())
                .then((data) => {
                    console.log(data);
                    if (data.status === 200) {
                      ...
                      <Col lg={9}>
                          <div className='dataright'>
                              <Row className='profilelocation'>
                                  ...
                                  <Col lg={6}>
                                              <button className="view-user-profile" onClick={() => removeshortlisted(data._id)}>Remove Profile</button>
...
export default MatrimonyShortlisted