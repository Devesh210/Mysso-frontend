...
const MatrimonyRequest = () => {
    ...
    const getdetails = () => {
        ...
        try {
            ...
            fetch(`${API_URL}/api/getInterestedProfiles`, requestOptions)
    ...
    const acceptlikedprofile = async (id) => {
        try {
            const requestOption = {
                method: "PUT",
                headers: {
            ...
            console.log(id);
            // return false
            await fetch(`${API_URL}/api/acceptlikedprofile`, requestOption)
                .then((res) => res.json())
                .then((data) => {
                    console.log(data);
                    if (data.status === 200) {
    ...
    const removelikedprofile = async (id) => {
        try {
            ...
            console.log(id)
            // return false
            await fetch(`${API_URL}/api/declinelikedprofile`, requestOption)
                .then((res) => res.json())
                .then((data) => {
                    console.log(data);
                    if (data.status === 200) {
                                ...
                                <Col lg={9}>
                                    <div className='dataright'>
                                        <Row className='profilelocation'>
                                            ...
                                            <Col lg={6}>
                                                <button className="view-user-decline" onClick={() => removelikedprofile(data._id)}>Decline</button>
                                                <button className="view-user-accept" onClick={() => acceptlikedprofile(data._id)}>Accept</button>
...
export default MatrimonyRequest