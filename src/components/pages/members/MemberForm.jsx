    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // }
                ...
                await fetch(`${API_URL}/api/addMember`, requestoptions)
                    .then(response => response.json())
                    .then(data => {
                        console.log(data);
                        if (data.status === 200) {
                          ...
                          <Col lg={4} className='mb-2'>
                              ...
                              <Form.Group className="mb-3" controlId="formResient">
                                  <Form.Control
                                      ...
                                      onChange={(e) => setResidentialAddress(e.target.value.slice(0, maxCharacters))}
                                      style={{ height: '180px' }}
                                      ref={residentialAddressRef}
                                  />
                              <small className='text-muted'>{residentialAddress.length}/{maxCharacters} characters</small>
                              </Form.Group>
                          ...
                          <Col lg={4} className='mb-2'>
                              ...
                              <Form.Group className="mb-3" controlId="formFullName">
                                  <Form.Control
                                      ...
                                      onChange={(e) => setBusinessDetails(e.target.value.slice(0, maxCharacters))}
                                      style={{ height: '180px' }}
                                      ref={businessDetailsRef}
                                  />
                              <small className='text-muted'>{businessDetails.length}/{maxCharacters} characters</small>
                              </Form.Group>
                          ...
                          <Col lg={4} className='mb-2'>
                              ...
                              <Form.Group className="mb-3" controlId="formFullName">
                                  <Form.Control
                                      ...
                                      value={shortBio}
                                      onChange={(e) => setShortBio(e.target.value.slice(0, maxCharacters))}
                                      style={{ height: '180px' }}
                                      ref={shortBioRef}
                                  />
                              <small className='text-muted'>{shortBio.length}/{maxCharacters} characters</small>
                              </Form.Group>
                          ...
                          <Col lg={4} className='mb-2'>
                              ...
                              <Form.Group className="mb-3" controlId="formFullName">
                                  <Form.Control
                                      ...
                                      value={purpose}
                                      onChange={(e) => setPurpose(e.target.value.slice(0, maxCharacters))}
                                      style={{ height: '180px' }}
                                      ref={purposeRef}
                                  />
                                  <small className='text-muted'>{purpose.length}/{maxCharacters} characters</small>
                              </Form.Group>
                          </Col>
                          <Col lg={4} className='mb-2'>
