...
const ChiefPatronMember = () => {
    ...
    useEffect(() => {
        ...
        setPage(currentPage);
        getChiefPatronMembers(page, perPage)
    }, [])

    const getChiefPatronMembers = async () => {
        try {
            setLoading(true)
            ...
            await fetch(`${API_URL}/api/getChiefPatronmemberslist?page=${page}&limit=${perPage}`, requestOptions)
    ...
    const handlePageClick = (e) => {
        ...
        getChiefPatronMembers(selectedPage, perPage);
    };
...
export default ChiefPatronMember