...
const DirectorMember = () => {
    ...
    useEffect(() => {
        ...
        setPage(currentPage);
        getDirectorMembers(page, perPage)
    }, [])

    const getDirectorMembers = async () => {
        try {
            setLoading(true)
            ...
            await fetch(`${API_URL}/api/getDirectormemberslist?page=${page}&limit=${perPage}`, requestOptions)
    ...
    const handlePageClick = (e) => {
        ...
        getDirectorMembers(selectedPage, perPage);
    };
