                    ...
                    <div className='descr-content'>
                        <Row>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" placeholder="Enter Your Profession name" onChange={(e) => setProfession(e.target.value)} ref={professionRef}/>
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Professional Experience (In Years) <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail" >
                                    <Form.Control type="text" placeholder="Enter Professional Experience (In Years)" onInput={allowOnlyNumbers} maxLength={3} onChange={(e) => setProfessional_industry_exp(e.target.value)} ref={professionalIndustryExpRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Profession Type <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail" >
                                    <Form.Control type="text" placeholder="Enter Profession Type" onChange={(e) => setProfession_Type(e.target.value)} ref={professionTypeRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                                <label>Firm Name <span className='labelerrorssss'>*</span></label>
                                <Form.Group className="mb-3" controlId="formBasicEmail" >
                                    <Form.Control type="text" placeholder="Enter Firm Name" onChange={(e) => setfirmName(e.target.value)} ref={firmNameRef} />
                                </Form.Group>
                            </Col>
                            <Col lg={4} className='mb-2'>
                            ...
                            <Col lg={4} className='mb-2'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail" >
                                    <Form.Control as="textarea"
                                        rows={3}
                                        placeholder="Enter Profession Full Address"
