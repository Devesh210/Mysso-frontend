                ...
                <Row>
                    ...
                    <Col lg={4}>
                        <div className='support-content'>
                            <img src={profile} alt="" />
                            <h3>Most Trusted</h3>
                            <p>With deep roots in the Swaminarayan sampraday, we take pride in being our community's most trusted Networking platform.</p>
                        </div>
                    </Col>
                    <Col lg={4}>
                        <div className='support-content'>
                            <img src={call} alt="" />
                            <h3>Our Support</h3>
                            <p>At ShreeSSO, we understand that the path to finding a Network can sometimes be challenging. That’s why we offer dedicated support to ensure a seamless and stress-free experience for our members.  </p>
                        </div>
                    </Col>
                </Row>
            </Container>
