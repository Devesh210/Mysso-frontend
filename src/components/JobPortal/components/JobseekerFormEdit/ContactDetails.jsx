...
const ContactDetails = ({ values, errors, touched, setFieldValue }) => {
    return (
            ...
            <div className='container'>
                <Row className='pb-4'>
                    <Col lg={4} className="pb-4">
                        ...
                        <Field name="email"  disabled={true} as={Form.Control} placeholder="Email" />
                    ...
                    <Col lg={4} className="pb-4">
                        ...
                        <PhoneInput
                            className={`form-control ${errors.jobApplication?.ContactDetails?.phone && touched.jobApplication?.ContactDetails?.phone ? 'is-invalid' : ''}`}
                            defaultCountry='IN'
                            international
