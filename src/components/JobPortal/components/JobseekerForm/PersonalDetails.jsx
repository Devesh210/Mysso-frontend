...
const PersonalDetails = ({ values, errors, touched, isSubmitting, setFieldValue, profilePhotoRef }) => {
        ...
        <div className='profilegallery mb-5'>
            ...
            <div className='container'>
                <Row className='mb-4'>
                    <Col lg={3}>
                        <div className='profileimgc  text-center'>
                            ...
                            <div className='profilephoto edit' id="personalDetails.profilephoto" onClick={() => document.getElementById('uploadInput').click()}>
                    ...
                    <Col lg={9}>
                        ...
                        <Row>
                            ...
                            <Col lg={4}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Middle Name<span className='labelerrorssss'>*</span></Form.Label>
                            ...
                            <Col lg={4}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Last Name<span className='labelerrorssss'>*</span></Form.Label>
                            ...
                            <Col lg={4}>
                                ...
                                <Form.Group className="mb-3">
                                    <Form.Label>Date of Birth<span className='labelerrorssss'>*</span></Form.Label>
                            ...
                            <Col lg={4}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Place of Birth<span className='labelerrorssss'>*</span></Form.Label>
                            ...
                            <Col lg={4}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Age (as of 2024)<span className='labelerrorssss'>*</span></Form.Label>
                                    <Field name="personalDetails.age" disabled={true} as={Form.Control} type="number" placeholder="Age (as of 2024)" />
                                    <ErrorMessage name="personalDetails.age" component="div" className="text-danger" />
                                </Form.Group>
                            </Col>
                            <Col lg={4}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Current Location<span className='labelerrorssss'>*</span></Form.Label>
                            ...
                            <Col md={4}>
                                <Form.Group>
                                    <Form.Label>Languages Known <span className='labelerrorssss'>*</span></Form.Label>
                ...
                <Row>
                    ...
                    <Col lg={4}>
                        <Form.Group className="mb-3">
                            <Form.Label>Street<span className='labelerrorssss'>*</span></Form.Label>
                    ...
                    <Col lg={4}>
                        <Form.Group className="mb-3">
                            <Form.Label>Pin Code<span className='labelerrorssss'>*</span></Form.Label>
