...
import {
  ...
  Alert,
  Button,
} from "react-bootstrap"; // Use other Bootstrap components but avoid 'Form' here
...
import { degrees, jobTypes } from "../../../utils";
...
const JobSetup = () => {
  ...
  } = useGetAdminJobById(params.id, setCities, setStates);
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      setLoading(true);
      const res = await updateJob({ id: params.id, data: values }).unwrap();

      if (res.success) {
        dispatch(setEditJob(res.job));
        swal("Success", res.message, "success");
        setTimeout(() => { navigate("/admin/jobs"); }, 100);
      }
    } catch (error) {
  ...
  if (AdminIderror) {
    return <Alert variant="info">{AdminIderror.message}</Alert>;
  }
            ...
            >
              <Container fluid className="matrimonialform mt-5 mb-5">
                    ...
                    <Row>
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            Title <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <Field
                            name="title"
                            type="text"
                      ...
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            Experience <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <div className="d-flex">
                            <Field
                              name="min_years"
                      ...
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            No Of Vacancy <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <Field
                            name="position"
                            type="number"
                      ...
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            Education <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <Field
                            name="education"
                            as="select"
                      ...
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            Job Type <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <Field
                            name="jobType"
                            as="select"
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Field name="tags">
                            {({ field, form }) => {
                              ...
                              const formattedTags = field?.value?.map(
                                (tag) => ({
                                  label: tag.trim(),
                                  value: tag.trim(),
                                })
                      ...
                      <Col lg={4}>
                        <Form.Group className="d-inline-grid mb-3">
                          <DatePickerField
                      ...
                      <Col lg={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            Category <span className="labelerrorssss">*</span>
                          </Form.Label>
                          <Field
                            name="category"
                ...
                <div className='profilegallery mb-5'>
                  ...
                  <div className='descr-content'>
                    <Form.Group className="mb-3">
                      <Field name="requirements" as="textarea" rows="7" style={{ height: 'auto' }} className="form-control" />
                        ...
                        <div>
                          {values?.benefits?.length > 0 &&
                            values?.benefits?.map((benefit, index) => (
                              <div className="row nb-2" key={index}>
                                <div className="col">
                                  <Field
                                    name={`benefits.${index}`}
                ...
                <div className="text-center mt-4">
                  {loading || isLoading || isSubmitting ? (
                    ...
                    <Button type="submit" className="submitforms">
                      Update Job
                    </Button>
                  )}
                </div>
